...
public class WebDriverDecorator implements WebDriver {
    ...
    private static final int EXPLICIT_WAIT = Integer.parseInt(PropertiesReader.getPropertyValue("EXPLICIT_WAIT"));
    private static final int IMPLICIT_WAIT = Integer.parseInt(PropertiesReader.getPropertyValue("IMPLICIT_WAIT"));
    ...
    public boolean isElementPresent(WebElement element) {
        try {
            ...
            LogManager.getLogger(WebDriverDecorator.class).error(e.getMessage());
            return false;
        }
        return true;
    }
